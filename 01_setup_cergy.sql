...
--  Instance simulée : schéma CYTECH_CERGY
-- ============================================================
...
-- ============================================================
-- 2. UTILISATEUR / SCHÉMA LOCAL CERGY
-- ============================================================
...
-- donner tous les droits nécessaires
...
-- ============================================================
-- 3. CONNEXION EN TANT QUE CYTECH_CERGY
-- ============================================================
...
CREATE SEQUENCE SEQ_MANUF      START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_ATYPE      START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_MODEL      START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_STATE      START WITH 1 INCREMENT BY 1 NOCACHE;
...
CREATE SEQUENCE SEQ_OSFAM      START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_OSVER      START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_ARCH       START WITH 1 INCREMENT BY 1 NOCACHE;
...
-- ============================================================
-- 5. TABLES DE RÉFÉRENTIELS (partagés / répliqués)
--    Ces tables seront identiques sur CYTECH_PAU
-- ============================================================
...
CREATE TABLE BUILDING (
  ...
  CONSTRAINT CK_BUILD_SITE CHECK (site_id = 1)   -- fragment Cergy
) TABLESPACE DATA_CERGY;
...
CREATE TABLE APP_USER (
  ...
  CONSTRAINT CK_USER_SITE CHECK (home_site_id = 1)  -- fragment Cergy
) TABLESPACE DATA_CERGY;
...
CREATE TABLE ASSET (
  ...
  CONSTRAINT CK_ASSET_SITE CHECK (site_id = 1)  -- fragment Cergy
) TABLESPACE DATA_CERGY;
...
CREATE TABLE VLAN (
  ...
  CONSTRAINT CK_VLAN_SITE CHECK (site_id = 1)  -- fragment Cergy
) TABLESPACE DATA_CERGY;
...
CREATE TABLE NETWORK_SEGMENT (
  ...
  CONSTRAINT CK_SEG_SITE CHECK (site_id = 1)  -- fragment Cergy
) TABLESPACE DATA_CERGY;
...
-- ASSET : index composites fréquents
...
-- ============================================================
-- 8. CLUSTER (PORT - IP, jointure fréquente)
-- ============================================================

CREATE CLUSTER CL_PORT_IP (port_id NUMBER)
  SIZE 256 TABLESPACE DATA_CERGY;

CREATE INDEX IDX_CL_PORT_IP ON CLUSTER CL_PORT_IP;

-- NOTE : pour utiliser le cluster, créer les tables dans le cluster :
-- CREATE TABLE NETWORK_PORT_C (...) CLUSTER CL_PORT_IP (port_id);
-- CREATE TABLE IP_ADDRESS_C   (...) CLUSTER CL_PORT_IP (port_id);
-- (démonstration de concept en soutenance)


-- ============================================================
-- 9. DONNÉES DE RÉFÉRENCE (identiques sur les 2 sites)
-- ============================================================

INSERT INTO SITE VALUES (1, 'CERGY', 'CY Tech Cergy',    'Cergy',    'Y');
INSERT INTO SITE VALUES (2, 'PAU',   'CY Tech Pau',      'Pau',      'Y');

INSERT INTO APP_ROLE VALUES (SEQ_ROLE.NEXTVAL, 'ADMIN_GLOBAL', 'Administrateur Global',       'GLOBAL');
INSERT INTO APP_ROLE VALUES (SEQ_ROLE.NEXTVAL, 'IT_SITE',      'Technicien SI Site',          'SITE');
INSERT INTO APP_ROLE VALUES (SEQ_ROLE.NEXTVAL, 'USER_SITE',    'Utilisateur Site',            'LOCAL');
INSERT INTO APP_ROLE VALUES (SEQ_ROLE.NEXTVAL, 'AUDITEUR',     'Auditeur / Reporting Global', 'GLOBAL');

INSERT INTO ASSET_TYPE VALUES (SEQ_ATYPE.NEXTVAL, 'PC',       'Ordinateur fixe');
INSERT INTO ASSET_TYPE VALUES (SEQ_ATYPE.NEXTVAL, 'LAPTOP',   'Ordinateur portable');
INSERT INTO ASSET_TYPE VALUES (SEQ_ATYPE.NEXTVAL, 'SERVER',   'Serveur');
INSERT INTO ASSET_TYPE VALUES (SEQ_ATYPE.NEXTVAL, 'SWITCH',   'Commutateur réseau');
INSERT INTO ASSET_TYPE VALUES (SEQ_ATYPE.NEXTVAL, 'ROUTER',   'Routeur');
INSERT INTO ASSET_TYPE VALUES (SEQ_ATYPE.NEXTVAL, 'PRINTER',  'Imprimante');

INSERT INTO ASSET_STATE VALUES (SEQ_STATE.NEXTVAL, 'IN_USE',    'En service',         'Y');
INSERT INTO ASSET_STATE VALUES (SEQ_STATE.NEXTVAL, 'STOCK',     'En stock',           'Y');
INSERT INTO ASSET_STATE VALUES (SEQ_STATE.NEXTVAL, 'REPAIR',    'En réparation',      'N');
INSERT INTO ASSET_STATE VALUES (SEQ_STATE.NEXTVAL, 'DISCARDED', 'Mis au rebut',       'N');
INSERT INTO ASSET_STATE VALUES (SEQ_STATE.NEXTVAL, 'LOST',      'Perdu / Volé',       'N');

INSERT INTO MANUFACTURER VALUES (SEQ_MANUF.NEXTVAL, 'Dell');
INSERT INTO MANUFACTURER VALUES (SEQ_MANUF.NEXTVAL, 'HP');
INSERT INTO MANUFACTURER VALUES (SEQ_MANUF.NEXTVAL, 'Lenovo');
INSERT INTO MANUFACTURER VALUES (SEQ_MANUF.NEXTVAL, 'Cisco');
INSERT INTO MANUFACTURER VALUES (SEQ_MANUF.NEXTVAL, 'Apple');

INSERT INTO OS_FAMILY VALUES (SEQ_OSFAM.NEXTVAL, 'Windows');
INSERT INTO OS_FAMILY VALUES (SEQ_OSFAM.NEXTVAL, 'Linux');
INSERT INTO OS_FAMILY VALUES (SEQ_OSFAM.NEXTVAL, 'macOS');

INSERT INTO OS_VERSION VALUES (SEQ_OSVER.NEXTVAL, 1, 'Windows 11',     3);
INSERT INTO OS_VERSION VALUES (SEQ_OSVER.NEXTVAL, 1, 'Windows 10',     2);
INSERT INTO OS_VERSION VALUES (SEQ_OSVER.NEXTVAL, 2, 'Ubuntu 24.04',   3);
INSERT INTO OS_VERSION VALUES (SEQ_OSVER.NEXTVAL, 2, 'Debian 12',      2);
INSERT INTO OS_VERSION VALUES (SEQ_OSVER.NEXTVAL, 3, 'macOS Sequoia',  3);

INSERT INTO CPU_ARCH VALUES (SEQ_ARCH.NEXTVAL, 'x86_64', 64);
INSERT INTO CPU_ARCH VALUES (SEQ_ARCH.NEXTVAL, 'ARM64',  64);
INSERT INTO CPU_ARCH VALUES (SEQ_ARCH.NEXTVAL, 'x86',    32);

INSERT INTO ASSET_MODEL VALUES (SEQ_MODEL.NEXTVAL, 1, 1, 'OptiPlex 7090',       'OP7090',  4, 180, 40);
INSERT INTO ASSET_MODEL VALUES (SEQ_MODEL.NEXTVAL, 3, 2, 'ThinkPad X1 Carbon',  'TPXC',    0,  65, 18);
INSERT INTO ASSET_MODEL VALUES (SEQ_MODEL.NEXTVAL, 2, 3, 'ProLiant DL380 Gen10','DL380',    2, 800, 74);
INSERT INTO ASSET_MODEL VALUES (SEQ_MODEL.NEXTVAL, 4, 4, 'Catalyst 2960X',      'C2960X',  1,  60, 44);

COMMIT;


-- ============================================================
-- 10. QUELQUES DONNÉES LOCALES CERGY
-- ============================================================
...
-- ============================================================
-- 11. DATABASE LINK vers PAU (à exécuter en tant que CYTECH_CERGY)
-- ============================================================

CREATE DATABASE LINK LNK_PAU
  CONNECT TO CYTECH_PAU IDENTIFIED BY pau2026
  USING 'XE';   -- Remplacer XE par le nom réel de votre service Oracle


-- ============================================================
-- 12. VUES GLOBALES FÉDÉRÉES (données Cergy + données Pau via DB Link)
-- ============================================================
