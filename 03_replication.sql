...
-- ---- MVs : SITE et PERSON_ROLE appartiennent a Pau ----
...
-- ---- Procedure ticket cross-site (Cergy = gestionnaire central) ----
...
-- ---- MVs : DEVICE_TYPE, PERIPHERAL_TYPE, OS_FAMILY, OS_VERSION appartiennent a Cergy ----
...
-- ---- Vue acces tickets Cergy depuis Pau ----
...
-- ---- Procedure ouverture ticket depuis Pau (insere sur Cergy) ----
